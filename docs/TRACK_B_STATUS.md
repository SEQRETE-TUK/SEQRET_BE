...
- **남은 구현:** INT-06 [#93](https://github.com/SEQRETE-TUK/SEQRET_BE/issues/93)의 FAILED 저장→reopen crash-window와 승인된 파생 처리 정책. FE 첫 촬영 E2E slice는 #4, A-06 분석 검토는 #5·#6으로 연동됐다.
