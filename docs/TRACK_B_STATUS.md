...
| **B-06** | worker 멱등성 + 오류 매핑 | ✅ | 없음 — INT-06 retry crash-window·출처 매핑·staging E2E 완료 | [#81](https://github.com/SEQRETE-TUK/SEQRET_BE/pull/81), [#82](https://github.com/SEQRETE-TUK/SEQRET_BE/pull/82), [#84](https://github.com/SEQRETE-TUK/SEQRET_BE/pull/84), [#103](https://github.com/SEQRETE-TUK/SEQRET_BE/pull/103), [#105](https://github.com/SEQRETE-TUK/SEQRET_BE/pull/105) |
...
| **INT-06** | task 재시도·provider 장애·복구 | B | ✅ | #103·#104·#105·#113~#115와 staging actual 분석·범위 import 완료 — [#93](https://github.com/SEQRETE-TUK/SEQRET_BE/issues/93) |

---

## 한눈에 요약

- **병합 완료:** GCS SDK #37, B-01 #39, B-02 #73, B-03 #35, B-04 #79, B-05 validation, B-06 #81·#82·#84, INT-06 진단·재시도·출처 매핑 #103·#104·#105·#113·#114·#115, B-07 #36
- **INT-01 완료 범위:** MIME 계약 #85·#86, event 계약 #87, 촬영 제출·durable dispatch·범위 초안 import, Vertex runtime wiring과 staging 배포 `c7b6e77`
- **INT-01·INT-06 완료 증적:** [staging #31938632411](https://github.com/SEQRETE-TUK/SEQRET_BE/actions/runs/31938632411)에서 실제 GCS upload·validation `READY`·Vertex 분석 `completed`·범위 초안 3개 import와 PostgreSQL scope·완료 event 각 1건을 확인했다. [#104](https://github.com/SEQRETE-TUK/SEQRET_BE/pull/104)는 동시 완료 exactly-once를 PostgreSQL로 검증한다.
...
- **남은 구현:** 확정된 B·INT-06 범위에는 없다. FE 첫 촬영 E2E slice는 #4, A-06 분석 검토는 #5·#6으로 연동됐다. v1은 검증된 원본만 사용하며 파생물은 현재 blocker가 아니다.
...
[B-02 + B-04 #79 + B-06 + #103/#104/#105/#113~#115] → INT-06 ✅
